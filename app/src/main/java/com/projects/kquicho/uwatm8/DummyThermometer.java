...
public class DummyThermometer extends View {
    ...
    private void init() {
        ...
        mFirstOuterCirclePaint.setColor(Color.RED);
        ...
        mFirstOuterArcPaint.setColor(Color.RED);
        ...
        mInnerLinePaint.setColor(Color.RED);
        ...
        mFirstOuterLinePaint.setColor(Color.RED);
